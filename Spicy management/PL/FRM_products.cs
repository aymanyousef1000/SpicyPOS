...
namespace Spicy_management.PL
{
    ...
    //gridControl1.DataSource = dbContext.TB_Cat.Local.ToBindingList();
        ...
        {
            PL.Add_Product frm_addproduct = new PL.Add_Product();
            frm_addproduct.Show();
        }
        ...
        private void simpleButton4_Click(object sender, EventArgs e)
        {
            update_data();
            edit_search.Text = "";
            dataGridView1.DataSource = db.TB_Products.Where(x => x.product_name.Contains("")).ToList();
        }

        private void update_data()
        {
            db = new DB_SpicyEntities3();
            dataGridView1.DataSource = db.TB_Products.ToList();
        }
            ...
            try
            {
               ...
               // idd = Convert.ToInt32(tileView1.GetFocusedRowCellValue("ID"));
                ...
                if (rs == DialogResult.Yes)
                {
                    ...
                    var r = db.TB_Products.Find(id);
                    db.TB_Products.Remove(r);
        ...
        {
            // TODO: This line of code loads data into the 'dB_SpicyDataSet5.TB_Products' table. You can move, or remove it, as needed.
            this.tB_ProductsTableAdapter.Fill(this.dB_SpicyDataSet5.TB_Products);
        ...
        private void button_search_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = db.TB_Products.Where(x => x.product_name.Contains(txt_search)).ToList();
