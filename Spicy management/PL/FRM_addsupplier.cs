...
namespace Spicy_management.PL
{
    public partial class FRM_addsupplier : Form
    {
        ...
        PL.FRM_suppliers frm = new PL.FRM_suppliers();
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            try
            {
                if (edit_name.Text != "")
                {
                    tb_suppliers.Supplier_Name = edit_name.Text;
                    db.TB_Supplier.Add(tb_suppliers);
                    db.SaveChanges();
                    ...
                    frm.dataGridView1.DataSource = db.TB_Supplier.ToList();
                    edit_name.Text = "";
                    this.Close();
                }
                else
